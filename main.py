...
# details = make_soup(url=f'https://nextspaceflight.com/launches/details/7129')
...
with open(r'C:\Users\33634\Desktop\Space-App\assets\data\next_launch_data.json', 'w', encoding='utf-8') as json_file:
